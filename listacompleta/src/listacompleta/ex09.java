...
public class ex09 {
	...
	public static void main(String[] args){
		...
		if(media >= 9 && media <= 10) {
			JOptionPane.showMessageDialog(null, "A media ponderada e : " +  media + ", classificacao A. ");	
		}else if(media >= 8 && media < 9){
			JOptionPane.showMessageDialog(null, "A media ponderada e : " +  media + ", classificacao B. ");	
		}else if(media >= 7 && media < 8){
			JOptionPane.showMessageDialog(null, "A media ponderada e : " +  media + ", classificacao C. ");	
		}else if(media >= 6 && media < 7){
			JOptionPane.showMessageDialog(null, "A media ponderada e : " +  media + ", classificacao D. ");	
		}else if(media < 6){
			JOptionPane.showMessageDialog(null, "A media ponderada e : " +  media + ", classificacao F. ");	
		}
	}
}
